...
public final class ActivityStudentCommentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityStudentCommentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityStudentCommentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_student_comment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityStudentCommentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.editTextStudentComment;
      EditText editTextStudentComment = ViewBindings.findChildViewById(rootView, id);
      if (editTextStudentComment == null) {
        break missingId;
      }
